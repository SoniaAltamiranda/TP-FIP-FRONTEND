  ...
  return (
    <div className="mt-16">
      ...
      {properties.map((property, index) => (
        <div key={property.id} className={`my-card ${index > 0 ? 'border-t border-gray-300 pt-4' : ''}`}>
            ...
            <div className="w-3/4 p-4">
              ...
              <div className="text-center mt-4">
                <Link
                  ...
                  state={{ property }}
                  className="inline-block bg-gray-700 text-white my-2 py-2 px-4 rounded-full hover-bg-blue-700 mx-auto"
                >
                  Modificar
                </Link>
                <button
